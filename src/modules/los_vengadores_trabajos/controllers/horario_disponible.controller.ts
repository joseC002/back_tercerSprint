...
export const getHorariosPorFecha = async (req: Request, res: Response) => {
  try {
    ...
    const horarios = await HorarioDisponible.find({ fecha })
...
export const crearHorario = async (req: Request, res: Response) => {
  try {
    ...
    const nuevoHorario = new HorarioDisponible({
      proveedorId,
      fecha,
      horaInicio,
      horaFin
...
export const eliminarHorario = async (req: Request, res: Response) => {
  ...
  try {
    const eliminado = await HorarioDisponible.findByIdAndDelete(id);
...
export const actualizarHorario = async (req: Request, res: Response) => {
  ...
  try {
    const actualizado = await HorarioDisponible.findByIdAndUpdate(
      id,
